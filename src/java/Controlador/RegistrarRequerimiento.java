 ...
 */
@WebServlet(name = "RegistrarRequerimiento", urlPatterns = {"/RegistrarRequerimiento"})
public class RegistrarRequerimiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (
            ...
            if (tipo.equals("producto")){
                json = RequerimientoDAO.obtenerProducto(numero);
            }
            else if (tipo.equals("requerimiento")){
                json = RequerimientoDAO.agregarRequerimiento(ventaCompleta);
            }
