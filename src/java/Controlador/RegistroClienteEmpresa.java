 ...
 */
@WebServlet(name = "RegistroClienteEmpresa", urlPatterns = {"/RegistroClienteEmpresa"})
public class RegistroClienteEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ClienteEmpresaDTO cliente = new ClienteEmpresaDTO();
            cliente.setRazonCliente(request.getParameter("razonCliente"));
            cliente.setRucCliente(request.getParameter("rucCliente"));
            ...
            cliente.setPasswordCliente(request.getParameter("passwordCliente"));
            cliente.setUrlCliente(request.getParameter("urlCliente"));

  
            int registrovalid = ClienteEmpresaDAO.Register(cliente);
            ...
            {
                response.setContentType("text/plain");
                response.getWriter().write("error ruc");
            }
