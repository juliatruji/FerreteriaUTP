...
<%
    ClienteNaturalDTO[] obj_cliente = (ClienteNaturalDTO[]) session.getAttribute("listaclienteNatural");
                ...
                <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
                    ...
                    <div class="navbar-collapse collapse" id="navbarNavAltMarkup" style="">
                        <div class="navbar-nav">
                            <h5 class="nav-item nav-link active" href="#">Ferretería UTP - Clientes Natural <span
                            ...
                            <div class="row">
                                <table class="table table-striped table-hover table-dark text-center">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                            <td><% out.println(obj_cliente[i].getNombresCliente()); %></td>
                                            <td><% out.println(obj_cliente[i].getApellidosCliente()); %></td>
                                            <td><% out.println(obj_cliente[i].getDniCliente()); %></td>
