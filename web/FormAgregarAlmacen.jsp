...
<%System.out.println("llega a esta pagina");%>
...
<body>
	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('./assets/images/bg-02.jpg');">
			<div class="wrap-login100">
                            <form id="formAgregarAlmacen" class="login100-form validate-form" action="RegistroAlmacen " method="POST">
					<!-- <span class="login100-form-logo">
						<i class="zmdi zmdi-landscape"></i>
					</span> -->

					<span class="login100-form-title p-b-34 p-t-27">
							<i class="zmdi zmdi-account-add"></i> Agregar  Almacen
					</span>

					<div class="wrap-input100 validate-input" data-validate="nombre">
						<input id="nombreAlmacen" class="input100" type="text" name="nombreAlmacen" placeholder="Nombre Almacen">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="ubicacion">
						<input id="ubicacionAlmacen" class="input100" type="text" name="ubicacionAlmacen" placeholder="Ubicacion Almacen">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="telefono">
							<input id="telefonoAlmacen" class="input100" type="text" name="telefonoAlmacen"  placeholder="telefonoAlmacen">
							<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
				...
				<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="sendAjaxAlmacen()">
							Agregar
						</button>
					</div>
	...
	<div id="dropDownSelect1"></div>
     ...
     <div class="overlay">
        ...
        datos.urlAlmacen= "https://firebasestorage.googleapis.com/v0/b/contactos-9976e.appspot.com/o/img%2Fproducto.jpeg?alt=media&token=884b0407-01d8-452d-a86b-0de2f2978c96";
        $('.overlay').fadeOut();
        ...
        <script>
                        ...
                        function sendAjaxAlmacen() {
                            event.preventDefault();
                            if(!validarForm()) {
                                return;
                            }
                            datos.nombreAlmacen = $('#nombreAlmacen').val();
                            datos.ubicacionAlmacen = $('#ubicacionAlmacen').val();
                            datos.telefonoAlmacen = $('#telefonoAlmacen').val();
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    ubicacionAlmacen: datos.ubicacionAlmacen,
                                    telefonoAlmacen: datos.telefonoAlmacen,
                                    urlAlmacen:datos.urlAlmacen
                                    ...
                                    .done(function (data) {
                                        ...
                                        if (data === "error dni") {
                                            ...
                                            $('#formAgregarAlmacen').trigger("reset");
                                            fotoid.src = "";
                                            fotoid2.src = "";
                                            $('#fotocontainer').fadeOut();
                                        }
