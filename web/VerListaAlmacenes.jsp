...
<%
   AlmacenDTO[] obj_almacen =(AlmacenDTO[]) session.getAttribute("ListaAlmacen");
                ...
                <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
                    ...
                    <div class="navbar-collapse collapse" id="navbarNavAltMarkup" style="">
                        <div class="navbar-nav">
                            <h5 class="nav-item nav-link active" href="#">Ferretería UTP - Almacen <span
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <table class="table table-striped table-hover table-dark text-center">
                                    ...
                                    <tbody>
                                        <% 
                                            for (int i = 0; i < obj_almacen.length; i++) {
                                                
                                        %>
                                        <tr>
                                            <td><% out.println(obj_almacen[i].getNombreAlmacen()); %></td>
                                            <td><% out.println(obj_almacen[i].getUbicacionAlmacen()); %></td>
                                            <td><% out.println(obj_almacen[i].getTelefonoAlmacen()); %></td>
                                            <td><img src="<% out.println(obj_almacen[i].getUrlAlmacen()); %>"
                                                width="50" 
                                                height="50"
                                                />
